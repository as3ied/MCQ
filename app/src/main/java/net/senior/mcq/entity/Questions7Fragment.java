...
public class Questions7Fragment extends Fragment {
...
{StartActivity.id=1;}
        ...
        choice1.setText(AppDbManager.getInstance(getContext()).selectById(7).getText());
        ...
        choice2.setText(AppDbManager.getInstance(getContext()).selectById(14).getText());
