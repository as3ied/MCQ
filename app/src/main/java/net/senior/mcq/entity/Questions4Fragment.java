...
{StartActivity.id=1;}
        ...
        choice1.setText(AppDbManager.getInstance(getContext()).selectById(6).getText());
        choice2.setText(AppDbManager.getInstance(getActivity()).selectById(7).getText());
        choice3.setText(AppDbManager.getInstance(getActivity()).selectById(4).getText());
