...
public class Questions9Fragment extends Fragment {
...
{StartActivity.id=1;}
        ...
        choice1.setText(AppDbManager.getInstance(getContext()).selectById(11).getText());
        ...
        choice3.setText(AppDbManager.getInstance(getContext()).selectById(15).getText());
        ...
        choice4.setText(AppDbManager.getInstance(getContext()).selectById(13).getText());
