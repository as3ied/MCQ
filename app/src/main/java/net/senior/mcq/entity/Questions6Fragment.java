...
public class Questions6Fragment extends Fragment {
...
{StartActivity.id=1;}
        ...
        choice1.setText(AppDbManager.getInstance(getContext()).selectById(14).getText());
        choice2.setText(AppDbManager.getInstance(getContext()).selectById(6).getText());
        ...
        choice4.setText(AppDbManager.getInstance(getContext()).selectById(2).getText());
