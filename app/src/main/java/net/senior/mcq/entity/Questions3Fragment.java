...
{StartActivity.id=1;}
        ...
        choice1.setText(AppDbManager.getInstance(getContext()).selectById(3).getText());
        ...
        choice3.setText(AppDbManager.getInstance(getContext()).selectById(10).getText());
        choice4.setText(AppDbManager.getInstance(getContext()).selectById(12).getText());
