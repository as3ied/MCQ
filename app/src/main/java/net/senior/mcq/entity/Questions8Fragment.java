...
public class Questions8Fragment extends Fragment {
...
{StartActivity.id=1;}
        ...
        choice2.setText(AppDbManager.getInstance(getContext()).selectById(3).getText());
        choice3.setText(AppDbManager.getInstance(getContext()).selectById(7).getText());
