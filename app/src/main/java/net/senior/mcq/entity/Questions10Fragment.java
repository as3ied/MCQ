...
public class Questions10Fragment extends Fragment {
...
{StartActivity.id=1;}
        ...
        choice1.setText(AppDbManager.getInstance(getContext()).selectById(10).getText());
        ...
        choice2.setText(AppDbManager.getInstance(getContext()).selectById(5).getText());
        choice3.setText(AppDbManager.getInstance(getContext()).selectById(1).getText());
        choice4.setText(AppDbManager.getInstance(getContext()).selectById(7).getText());
